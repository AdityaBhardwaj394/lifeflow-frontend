...
const Chatuser = ({ route }) => {
  ...
  // const hospitalName = route.params.selectedHospital.poi.name;
  const hospitalName=route.params.selectedHospital.name
  console.log("Chatuser",route.params.selectedHospital.name);
